...
import { deleteDoctor } from '@/redux/thunks/doctorThunk';
import { deletePatient } from '@/redux/thunks/patientThunk';
import { Button, Card } from '@/ui';

export const DeleteEntity = ({ id, role }: {
	id: string,
	role: 'Doctor' | 'Patient'
}) => {
	...
	const handleDelete = async () => {
		try {
			const resultAction = await dispatch(
				role === 'Doctor' ? deleteDoctor(id) : deletePatient(id)
			);
